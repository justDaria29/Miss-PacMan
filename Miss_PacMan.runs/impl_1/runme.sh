...
HD_PWD='C:/Users/Daria/OneDrive/Documente/facultate/dsd-lab/Miss_PacMan/Miss_PacMan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pacman.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pacman.tcl -notrace
