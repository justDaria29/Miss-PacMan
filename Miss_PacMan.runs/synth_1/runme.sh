...
HD_PWD='C:/Users/Daria/OneDrive/Documente/facultate/dsd-lab/Miss_PacMan/Miss_PacMan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pacman.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pacman.tcl
