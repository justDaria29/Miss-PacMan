...
set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { ann[0] }]; IO_L23P_T3_FOE_B_15 Sch=ann[0]
set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { ann[1] }]; IO_L23N_T3_FWE_B_15 Sch=ann[1]
set_property -dict { PACKAGE_PIN T9    IOSTANDARD LVCMOS33 } [get_ports { ann[2] }]; IO_L24P_T3_A01_D17_14 Sch=ann[2]
set_property -dict { PACKAGE_PIN J14   IOSTANDARD LVCMOS33 } [get_ports { ann[3] }]; IO_L19P_T3_A22_15 Sch=ann[3]
set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVCMOS33 } [get_ports { ann[4] }]; IO_L8N_T1_D12_14 Sch=ann[4]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { ann[5] }]; IO_L14P_T2_SRCC_14 Sch=ann[5]
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { ann[6] }]; IO_L23P_T3_35 Sch=ann[6]
set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports { ann[7] }]; IO_L23N_T3_A02_D18_14 Sch=ann[7]
...
set_property -dict { PACKAGE_PIN N17   IOSTANDARD LVCMOS33 } [get_ports { c }]; IO_L9P_T1_DQS_14 Sch=c
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { u }]; IO_L4N_T0_D05_14 Sch=u
set_property -dict { PACKAGE_PIN P17   IOSTANDARD LVCMOS33 } [get_ports { l }]; IO_L12P_T1_MRCC_14 Sch=l
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { r }]; IO_L10N_T1_D15_14 Sch=r
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { d }]; IO_L9N_T1_DQS_D13_14 Sch=d
